...
//            model=new DefaultTableModel(null,Titulos);   
    ...
    void Agregar() {
        ...
        try {
            if (dni.equals("") || nombre.equals("")) {
                ...
                String sql = "insert into alumnos(dni,nombre) values('" + dni + "','" + nombre + "')";
                con = cn.getConnection();
                st = con.createStatement();
    ...
    void Modificar() {
        ...
        String sql = "update alumnos set dni='" + dni + "',nombre='" + nom + "' where idalumnos=" + id;
        try {
